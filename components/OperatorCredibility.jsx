...
export default function OperatorCredibility() {
  ...
  return (
    <section id="about" style={{
      background: 'linear-gradient(180deg, #0d1520 0%, #faf8f5 6%)',
      padding: '100px 0',
      position: 'relative',
      overflow: 'hidden',
    }}>
      ...
      <div style={{ position: 'absolute', top: '10%', right: '5%', width: '400px', height: '400px', background: 'radial-gradient(circle, rgba(196,150,50,0.04) 0%, transparent 70%)', pointerEvents: 'none', filter: 'blur(40px)' }} />
        ...
        <div className="credibility-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start' }}>
          ...
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '16px', padding: '5px 14px', background: 'rgba(196,150,50,0.08)', border: '1px solid rgba(196,150,50,0.2)', borderRadius: '20px' }}>
              ...
              <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '11px', fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#c49632' }}>Our Story</span>
            </div>

            <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(30px, 3.5vw, 50px)', fontWeight: 400, lineHeight: 1.12, letterSpacing: '-0.02em', color: '#1a1a1a', margin: '0 0 24px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '36px' }}>
              {[
                ...
                >
                  <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: '3px', background: 'linear-gradient(180deg, #c49632, transparent)' }} />
                  <span style={{ fontSize: '20px', flexShrink: 0 }}>{item.icon}</span>
                  <div>
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 600, color: '#1a1a1a', margin: '0 0 4px' }}>{item.title}</p>
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 300, lineHeight: 1.65, color: '#5a5248', margin: 0 }}>{item.body}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.borderColor = 'rgba(196,150,50,0.4)' }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = 'rgba(196,150,50,0.2)' }}
            >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{
              ...
              padding: '28px',
              border: '1px solid rgba(196,150,50,0.2)',
              boxShadow: '0 16px 48px rgba(13,21,32,0.15)',
            }}>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '10px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#c49632', margin: '0 0 18px' }}>The Ecosystem</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  <div key={item.name} style={{
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,0.07)'; e.currentTarget.style.borderColor = 'rgba(196,150,50,0.2)' }}
                  ...
                  >
                    ...
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '12px', color: 'rgba(255,255,255,0.4)', margin: 0 }}>{item.role}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '10px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#8a8076', margin: '0 0 14px' }}>Professional Foundations</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '9px 12px', background: '#f4f0e8', borderRadius: '8px', flexWrap: 'wrap', gap: '8px', transition: 'all 0.2s ease' }}
                    onMouseEnter={(e) => { e.currentTarget.style.background = '#ede8df' }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = '#f4f0e8' }}
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <div style={{ width: '7px', height: '7px', background: item.color, borderRadius: '50%', flexShrink: 0, boxShadow: `0 0 6px ${item.color}60` }} />
            ...
            <div style={{
              padding: '20px 24px',
              background: 'linear-gradient(135deg, #f4f0e8, white)',
              border: '1px solid #d5c5aa',
              borderRadius: '14px',
              position: 'relative',
              overflow: 'hidden',
            }}>
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '2px', background: 'linear-gradient(90deg, #c49632, #f0c050, #c49632)' }} />
              <p style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: '19px', fontStyle: 'italic', fontWeight: 400, color: '#1a1a1a', margin: '0 0 8px', lineHeight: 1.5 }}>
