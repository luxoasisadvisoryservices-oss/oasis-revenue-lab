...
export default function CredentialsSection() {
  return (
    <section id="credentials" style={{ background: '#f8f6f2', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
      <style>{`
        ...
        <div className="credentials-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start', marginBottom: '56px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ background: 'white', border: '1px solid #e0d8cc', borderRadius: '20px', padding: '28px', boxShadow: '0 4px 16px rgba(0,0,0,0.05)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '20px', background: '#f0ece4', border: '1px solid #e0d8cc', borderRadius: '12px', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '16px', transition: 'all 0.2s ease' }}
              ...
              >
                ...
                <div>
                  <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '14px', fontWeight: 600, color: '#111111', margin: '0 0 3px' }}>PriceLabs Expert Ecosystem</p>
                  <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '12px', color: '#504840', margin: '0 0 4px', fontWeight: 300, lineHeight: 1.5 }}>We configure and optimise PriceLabs strategies daily for live Dubai STR portfolios.</p>
                  <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '11px', color: '#2ebd72', fontWeight: 500 }}>Active practitioner</span>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  {['JBR', 'Dubai Marina', 'Downtown Dubai'].map((area) => (<span key={area} style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '11px', padding: '4px 10px', background: 'white', border: '1px solid #ccc0aa', borderRadius: '20px', color: '#504840' }}>{area}</span>))}
                </div>
              </div>
            </div>
            <div style={{ padding: '22px 24px', background: 'linear-gradient(135deg, #141414, #1e1e1e)', borderRadius: '14px', position: 'relative', overflow: 'hidden', border: '1px solid rgba(184,144,58,0.14)' }}>
              ...
              <p style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: '19px', fontStyle: 'italic', fontWeight: 400, color: 'rgba(255,255,255,0.82)', margin: '0 0 8px', lineHeight: 1.5 }}>A real revenue management company that built its own AI system.</p>
